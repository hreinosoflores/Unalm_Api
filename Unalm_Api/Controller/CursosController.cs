...
namespace Unalm_Api.Controller
{
    ...
    public class CursosController : ControllerBase
    {
        ...
        public CursosController(unalmContext context)
        {
            _context = context;
        }
        ...
        // GET: api/Cursos/5
        [HttpGet("{id}")]
        public async Task<ActionResult<Curso>> GetCurso(ulong id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutCurso(ulong id, Curso curso)
        {
            if (id != curso.Id)
            {
                return BadRequest();
        ...
        private bool CursoExists(ulong id)
        {
